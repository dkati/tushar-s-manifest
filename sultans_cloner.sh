...
git clone https://www.github.com/sultanxda/android_external_sony_boringssl-compat -b cm-13.0-caf external/sony/boringssl-compat
...
git clone https://www.github.com/sultanxda/android_packages_apps_Snap -b cm-13.0-sultan packages/apps/Snap
